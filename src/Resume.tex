...
\setYourJobTitle{Data Scientist/Machine Learning Engineer}
\setYourMobileNo{347-263-0441}
\setYourEmailAddr{pwharned@gmail.com}
\setYourWebAddr{pwharned.github.io}
...
\personalStatement{I am a Data Scientist and Machine Learning Engineer with a passion for NLP and performance computing.}
...
\newRole{2019 -- present}
        {Data Scientist}
        {IBM Expert Labs}
        {Develop and deploy novel AI solutions.}
        \newline


\roleAchievements{Developed monitoring platform for LLM workloads on NVIDIA GPUs.}
{Develop and research novel techniques for improving computational efficiency of LLM training and inferencing. Develop high performance inferencing engine for LLMs.}
{Fine tune geospatial foundation models and Large Langage Models (LLMS) on proprietary data.}
{Develop high throuput C++ applications for performing embdedded database machine learning to support model drift and explainabilty analysis on federated data. }
{Develop federated data platform for tracking bias across machine learning models deployed to Google Cloud. }
{Research applicability of LLMs in machine translation. }
